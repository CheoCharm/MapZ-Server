...
import static com.cheocharm.MapZ.common.fixtures.DiaryFixtures.CURRENT_PLACE_LATITUDE;
import static com.cheocharm.MapZ.common.fixtures.DiaryFixtures.CURRENT_ZOOM_LEVEL;
import static com.cheocharm.MapZ.common.fixtures.DiaryFixtures.LATITUDE_PARAM_NAME;
import static com.cheocharm.MapZ.common.fixtures.DiaryFixtures.LONGITUDE_PARAM_NAME;
import static com.cheocharm.MapZ.common.fixtures.DiaryFixtures.CURRENT_PLACE_LONGITUDE;
import static com.cheocharm.MapZ.common.fixtures.DiaryFixtures.ZOOM_LEVEL_PARAM_NAME;
...
class DiaryControllerTest extends ControllerTest {
    ...
    void getDiaryCoordinate() throws Exception {
        ...
        mockMvc.perform(get("/api/diary/low")
                        .param("longitude", CURRENT_PLACE_LONGITUDE)
                        .param("latitude", CURRENT_PLACE_LATITUDE)
                        .header(AUTHORIZATION_HEADER_NAME, accessToken)
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                )
    ...
    void getDiaryCoordinateWithTitleImage() throws Exception {
        ...
        mockMvc.perform(get("/api/diary/high")
                        .param(LONGITUDE_PARAM_NAME, CURRENT_PLACE_LONGITUDE)
                        .param(LATITUDE_PARAM_NAME, CURRENT_PLACE_LATITUDE)
                        .param(ZOOM_LEVEL_PARAM_NAME, CURRENT_ZOOM_LEVEL)
                        .header(AUTHORIZATION_HEADER_NAME, accessToken)
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                ).andDo(print())
