package com.mapz.api.group.presentation.controller;

import com.mapz.api.common.CommonResponse;
import com.mapz.api.group.application.GroupService;
...
public class GroupController {
    ...
    @Parameter(name = "accessToken", in = ParameterIn.HEADER, required = true)
    @GetMapping("/{page}")
    public CommonResponse<PagingGroupListResponse> getGroup(
            @RequestParam String groupName, @RequestParam Long cursorId, @PathVariable Integer page) {
    ...
    @Parameter(name = "accessToken", in = ParameterIn.HEADER, required = true)
    @DeleteMapping("/user/{groupId}/{userId}")
    public CommonResponse<?> kickUser(@PathVariable Long groupId, @PathVariable Long userId) {
    ...
    public CommonResponse<?> refuseInvitation(@PathVariable Long groupId) {
        groupService.refuseInvitation(groupId);
        return CommonResponse.success();
    }
